...
CREATE TABLE lotes (
    ...
    unidade_medida ENUNIT('unidade', 'caixa', 'frasco', 'ml', 'l', 'g', 'kg') DEFAULT 'unidade',
...
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeG4Z5yJ5b8vQ6y6v7v8v9v0v1v2v3v4v5', 'admin@perfumaria.com', 'Administrador Sistema', 'admin'),
('operador1', '$2a$10$N9qo8uLOickgx2ZMRZoMyeG4Z5yJ5b8vQ6y6v7v8v9v0v1v2v3v4v5', 'operador1@perfumaria.com', 'Operador Estoque', 'operator'),
('gerente1', '$2a$10$N9qo8uLOickgx2ZMRZoMyeG4Z5yJ5b8vQ6y6v7v8v9v0v1v2v3v4v5', 'gerente1@perfumaria.com', 'Gerente de Vendas', 'manager');
...
GROUP BY p.id, p.sku, p.nome, m.nome, l.nome, p.preco_venda
HAVING quantidade_total < p.estoque_minimo OR quantidade_vencendo_30_dias > 0 OR quantidade_vencida > 0
...
SELECT
    ...
    AVG(lote.margem_lucro_percentual) as margem_media_ponderada
FROM produtos p
JOIN linhas l ON p.linha_id = l.id
JOIN marcas m ON l.marca_id = m.id
