...
// Thunk para obter notificações
export const fetchNotifications = createAsyncThunk(
  'inventory/fetchNotifications',
  async (params, { rejectWithValue }) => {
    try {
...
export const markNotificationAsRead = createAsyncThunk(
  'inventory/markNotificationAsRead',
...
// Thunk para excluir notificação
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchNotifications.fulfilled, (state, action) => {
        state.isLoading = false;
        // For notifications, we might want to store them separately
        // For now, we'll just not store them in state since the hooks handle it
        // Or we could add a notifications field to state
      })
      ...
      .addCase(markNotificationAsRead.pending, (state) => {
        // Optional: show loading state for this specific action
      })
      .addCase(markNotificationAsRead.fulfilled, (state, action) => {
        // Success - notification marked as read
        // In a real app, you might update the specific notification in state
      })
      ...
      .addCase(deleteNotification.fulfilled, (state, action) => {
        ...
        // In a real app, you might remove the notification from state
      })
